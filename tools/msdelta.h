...
BOOL WINAPI ApplyDeltaGetReverseB(
...
BOOL WINAPI ApplyDeltaProvidedB(
    _In_ DELTA_FLAG_TYPE ApplyFlags,
    _In_ DELTA_INPUT Source,
    _In_ DELTA_INPUT Delta,
...
BOOL WINAPI GetDeltaSignatureB(
    _In_ DELTA_FILE_TYPE FileTypeSet,
    _In_ ALG_ID HashAlgId,
    _In_ DELTA_INPUT Source,
...
BOOL WINAPI GetDeltaSignatureA(
    _In_ DELTA_FILE_TYPE FileTypeSet,
    _In_ ALG_ID HashAlgId,
    _In_ LPCSTR lpSourceName,
    _Out_ LPDELTA_HASH lpHash
...
BOOL WINAPI GetDeltaSignatureW(
    _In_ DELTA_FILE_TYPE FileTypeSet,
    _In_ ALG_ID HashAlgId,
    _In_ LPCWSTR lpSourceName,
    _Out_ LPDELTA_HASH lpHash
...
BOOL WINAPI DeltaNormalizeProvidedB(
    _In_ DELTA_FILE_TYPE FileTypeSet,
...
BOOL WINAPI DeltaFree(_In_ LPVOID lpMemory);
